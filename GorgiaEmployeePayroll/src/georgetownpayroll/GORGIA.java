...
public class GORGIA {
	...
	private JFrame frmGorgeCleaningServisesemployee;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GORGIA window = new GORGIA();
					window.frmGorgeCleaningServisesemployee.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frmGorgeCleaningServisesemployee = new JFrame();
		frmGorgeCleaningServisesemployee.setTitle("GORGE CLEANING SERVISES-EMPLOYEE PAYROLL");
		frmGorgeCleaningServisesemployee.setBackground(new Color(28, 113, 216));
		frmGorgeCleaningServisesemployee.setBounds(100, 100, 861, 404);
		frmGorgeCleaningServisesemployee.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmGorgeCleaningServisesemployee.getContentPane().setLayout(null);
		...
		frmGorgeCleaningServisesemployee.getContentPane().add(panel);
		panel.setLayout(null);
		
		JLabel lblEmployeeName = new JLabel("Employee Name :");
		lblEmployeeName.setBounds(46, 33, 140, 15);
		panel.add(lblEmployeeName);
		
		Employeename = new JTextField();
		Employeename.setBounds(206, 32, 140, 17);
		...
		txtHourlySalary.setBounds(532, 32, 124, 17);
		...
		frmGorgeCleaningServisesemployee.getContentPane().add(panel_1);
		panel_1.setLayout(null);
		
		JLabel lblFirstWeek = new JLabel("First Week :");
		lblFirstWeek.setBounds(12, 55, 113, 14);
		panel_1.add(lblFirstWeek);
		
		JLabel lblSecondWeek = new JLabel("Second Week :");
		lblSecondWeek.setBounds(12, 96, 136, 14);
		...
		frmGorgeCleaningServisesemployee.getContentPane().add(panel_2);
		...
		lblRegular.setBounds(132, 46, 77, 14);
		panel_2.add(lblRegular);
		
		JLabel lblOvertime = new JLabel("Overtime:");
		lblOvertime.setBounds(132, 71, 77, 14);
		...
		btnProcessIt.setBounds(10, 22, 112, 76);
